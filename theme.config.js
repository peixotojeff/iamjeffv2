export default {
  ...
  footer: (<div className="my-24  border-t-2  mx-auto flex items-center sm:flex-row flex-col">
      ...
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        ...
        <a target="_blank" href="https://www.facebook.com/peixotojeff" className="text-gray-500">
        ...
        <a target="_blank" href="https://www.instagram.com/peixotojeff_/" className="ml-3 text-gray-500">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
          </svg>
        </a>
        <a target="_blank" href="https://www.linkedin.com/in/peixotojeff/" className="ml-3 text-gray-500">
